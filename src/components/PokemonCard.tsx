...
function ShadowFlame() {
	return (
		...
		>
			<path
				d="M12 2C11 5 8 8 8 12c0 2.8 1.8 5 4 5s4-2.2 4-5c0-4-4-10-4-10z"
				fill="url(#flameGrad)"
			/>
			<path
				d="M11 10c-.8 1.5-1.2 2.5-1.2 3.5 0 1.2.8 2 1.7 2a1.8 1.8 0 0 0 1.4-.7c-.3-.8-.3-1.8.1-2.8C12.4 13 11 10 11 10z"
				fill="#D7BDE2"
				opacity="0.85"
			/>
			<defs>
...
export default function PokemonCard({ mon }: { mon: Mon }) {
	...
	const displayName = [mon.species, mon.form ? `(${mon.form})` : null]
		.filter(Boolean)
		.join(" ");
		...
		>
			...
			<div className={styles.imageWrap}>
				<img
					...
					className={[
						styles.sprite,
						mon.shadow ? styles.shadowSprite : "",
					].join(" ")}
					onError={(e) => {
					...
					<div className={styles.moves}>
						{mon.fastMove && (
							<MoveRow
								...
								stat={
									mon.fastMoveTurns != null ? `${mon.fastMoveTurns}t` : null
								}
							/>
						)}
						{mon.chargeMove1 && (
